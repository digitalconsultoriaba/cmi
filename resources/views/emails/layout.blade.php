...
<head>
    ...
    <style>
        ...
        .band { background: #17357A; padding: 26px 24px; text-align: center; }
        .band img { width: 52px; height: 52px; }
        .band .kicker { margin: 10px 0 0; color: #C9A24B; font-size: 11px; letter-spacing: .22em; text-transform: uppercase; font-weight: 700; }
        .band .event { margin: 3px 0 0; color: #eaf0fb; font-family: Georgia, serif; font-size: 16px; font-weight: 600; }
...
<body>
    <div class="outer">
        <div class="card">
            <div class="band">
                <img src="{{ $logoUrl }}" alt="CMI · GLMEES">
                <div class="kicker">Grande Loja Maçônica do ES</div>
                <div class="event">{{ $eventName ?? 'Seminário Internacional 2026' }}</div>
            </div>
